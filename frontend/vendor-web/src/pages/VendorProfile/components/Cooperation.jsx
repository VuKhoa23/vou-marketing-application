            ...
            {sortedEvents.map((event, index) => (
                <Step key={index}>
                    ...
                    <VStack align="start" spacing={4} ml={6}>
                        <Box mt={2}>
                            <Text fontSize="sm" fontWeight="bold" color="blue.800">Từ {event.startDate} đến {event.endDate}</Text>
                        </Box>
                        <Box
                            p={4}
                            borderWidth={1}
                        ...
                        >
                            <Text fontSize="lg" fontWeight="bold" color="blue.600" whiteSpace="normal" overflowWrap="break-word" wordBreak="break-word">{event.name}</Text>
                            <Text fontSize="md" color="gray.600">{milestones[index].description}</Text>
